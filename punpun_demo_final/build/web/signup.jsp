            ...
            <div class="auth-container">
                <div class="card">
                    ...
                    <div class="auth-content">
                        ...
                        <form id="signup-form" action="dashboard-setting-profile.html" method="GET" novalidate="">
                        ...
                        <div class="form-group">
                            <p class="text-muted text-xs-center">มีบัญชีผู้ใช้อยู่แล้วหรือไม่? <a href="login.html">ลงชื่อเข้าใช้!</a></p>
                        </div>
                    </div>
                </div>
