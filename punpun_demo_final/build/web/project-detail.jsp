                                            ...
                                            <div class="card-block">
                                                ...
                                                <div data-exclude="xs,sm,lg">
                                                    ...
                                                    <ul class="item-list striped">
                                                        ...
                                                        <c:forEach var="member2" items="${result2.rows}">
                                                            <sql:query var="data" dataSource="punpun">
                                                                SELECT * FROM members where member_id = ${member2.member_id}
                                                            </sql:query>
                                                                    ...
                                                                    <div class="item-row">
                                                                        <div class="item-col fixed item-col-img md">
                                                                            <a href="item-editor.html">
                                                                                <div class="item-img rounded" style="background-image: url('assets/img/profile/0000${member2.member_id}.jpg')"></div>
                                                                            </a>
                                                                        </div>
                                                                        <!--Name of Team-->
